...
import boxuegu.example.packagecom.boxuegu.activity.ActivityVideoPlayActivity;
...
public class VideoListItemAdapter extends BaseAdapter {
    ...
    private void initializeViews(final VideoBean object,final ViewHolder holder,final int position,View converView) {
        //TODO implement
